...
//        toggle.syncState();
        ...
        textFullname =  (TextView) hearderView.findViewById(R.id.textFullname);
...
//Here Starts the other solution yarab yeshtghal
        //bne3mel options dy
        ...
        // hna bneb3t options bdal el araf bta3 abl kda
            ...
            protected void onBindViewHolder(@NonNull MenuViewHolder holder, int position, @NonNull Category model) {
                ...
                holder.setItemClickListner(new ItemClickListner() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //Get CategoryId & Send It to the next Activity
